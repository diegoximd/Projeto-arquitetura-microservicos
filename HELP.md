...
* The original package name 'one.digitalinnovation.experts.produtct-catalog' is invalid and this project uses 'one.digitalinnovation.experts.produtctcatalog' instead.
